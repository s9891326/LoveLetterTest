...
class LobbyTestCase(LoveLetterRepositoryAwareTestCase):
    def setUp(self) -> None:
        ...
        self.player_id: str = "6497f6f226b40d440b9a90cc"
    ...
    def test_1_start_game(self):
        players = [
            {"id": self.player_id, "nickname": "板橋金城武"},
    ...
    def test_2_game_status(self, mock_jwt_bearer):
        ...
        mock_jwt_bearer.get_player_id.return_value = self.player_id
        response = self.t.get(
        ...
        self.assertEqual(
            {
                ...
                "players": [
                    {"id": self.player_id, "name": "板橋金城武", "score": 0},
